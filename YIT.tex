...
\newfontfamily{\tp}{linja-pona-4.9.otf}
...
\tran{\textarab{al-`rbyTa} (ISO 639-3 arb)}{\textarab{tmhydyTa yUnydA}}{}
    \begin{arab} 
   ltkn $\mathcal{C}$ fy"'Ta .s.gyrTa w $F$ mdlAl mn hnh al-fy"'Ta fy al-fy"'Ta al-mjmw`At. lkl `n.sr $X$ mn $\mathcal C$, fi"'n ywjd tqAbl .tby`yTa byn mjmw`Ta al-t.hwylat al-.tby`yTa $\hom(-,X)\Rightarrow F$ w al-mjmw`Ta $FX$. hnh al-tmA_tl ^skly y`rf al-`mlyTa
    \end{arab}
    \[
	\Big(\xi : \hom(-,X)\Rightarrow F\Big) \mapsto \xi_X(1_X)
    \]
    (\textarab{hnh al-dAlTa tqAbAyTa}).
